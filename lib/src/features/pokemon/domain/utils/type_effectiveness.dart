class TypeEffectiveness {
  ...
  static Map<String, double> getEffectiveness(List<String> types) {
    Map<String, double> effectiveness = {};
    
    for (var defenderType in _chart.keys) {
      double multiplier = 1.0;
      for (var attackerType in types) {
        multiplier *= (_chart[attackerType]?[defenderType] ?? 1.0);
      }
      if (multiplier != 1.0) {
